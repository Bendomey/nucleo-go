...
type Action struct {
	name     string
	fullname string
	handler  nucleo.ActionHandler
	params   nucleo.ActionParams
}
...
type Event struct {
	...
	serviceName string
	group       string
	handler     nucleo.EventHandler
}

func (event *Event) Handler() nucleo.EventHandler {
...
type Service struct {
	...
	actions      []Action
	events       []Event
	created      nucleo.CreatedFunc
	started      nucleo.LifecycleFunc
	stopped      nucleo.LifecycleFunc
	schema       *nucleo.ServiceSchema
	logger       *log.Entry
}
...
func (serviceAction *Action) Handler() nucleo.ActionHandler {
...
func findAction(name string, actions []nucleo.Action) bool {
...
func extendActions(service nucleo.ServiceSchema, mixin *nucleo.Mixin) nucleo.ServiceSchema {
...
func mergeDependencies(service nucleo.ServiceSchema, mixin *nucleo.Mixin) nucleo.ServiceSchema {
	list := []string{}
...
func concatenateEvents(service nucleo.ServiceSchema, mixin *nucleo.Mixin) nucleo.ServiceSchema {
...
func extendSettings(service nucleo.ServiceSchema, mixin *nucleo.Mixin) nucleo.ServiceSchema {
	service.Settings = MergeSettings(mixin.Settings, service.Settings)
	return service
}

func extendMetadata(service nucleo.ServiceSchema, mixin *nucleo.Mixin) nucleo.ServiceSchema {
	service.Metadata = MergeSettings(mixin.Metadata, service.Metadata)
	return service
}

func extendHooks(service nucleo.ServiceSchema, mixin *nucleo.Mixin) nucleo.ServiceSchema {
...
func chainCreated(service nucleo.ServiceSchema, mixin *nucleo.Mixin) nucleo.ServiceSchema {
	if mixin.Created != nil {
		svcHook := service.Created
		mixinHook := mixin.Created
		service.Created = func(svc nucleo.ServiceSchema, log *log.Entry) {
			mixinHook(svc, log)
			if svcHook != nil {
				svcHook(svc, log)
			}
...
func chainStarted(service nucleo.ServiceSchema, mixin *nucleo.Mixin) nucleo.ServiceSchema {
	if mixin.Started != nil {
		svcHook := service.Started
		mixinHook := mixin.Started
		service.Started = func(ctx nucleo.BrokerContext, svc nucleo.ServiceSchema) {
			mixinHook(ctx, svc)
			if svcHook != nil {
				svcHook(ctx, svc)
			}
...
func chainStopped(service nucleo.ServiceSchema, mixin *nucleo.Mixin) nucleo.ServiceSchema {
	if mixin.Stopped != nil {
		svcHook := service.Stopped
		mixinHook := mixin.Stopped
		service.Stopped = func(ctx nucleo.BrokerContext, svc nucleo.ServiceSchema) {
			mixinHook(ctx, svc)
			if svcHook != nil {
				svcHook(ctx, svc)
			}
...
func applyMixins(service nucleo.ServiceSchema) nucleo.ServiceSchema {
...
func CreateServiceEvent(eventName, serviceName, group string, handler nucleo.EventHandler) Event {
	return Event{
		eventName,
		serviceName,
		group,
...
func CreateServiceAction(serviceName string, actionName string, handler nucleo.ActionHandler, params nucleo.ActionParams) Action {
	return Action{
		actionName,
...
// populateFromSchema populate a service with data from a nucleo.Service.
...
func copyVersion(obj interface{}, schema nucleo.ServiceSchema) nucleo.ServiceSchema {
...
func copyDependencies(obj interface{}, schema nucleo.ServiceSchema) nucleo.ServiceSchema {
...
func copyEvents(obj interface{}, schema nucleo.ServiceSchema) nucleo.ServiceSchema {
...
func copyMetadata(obj interface{}, schema nucleo.ServiceSchema) nucleo.ServiceSchema {
...
func copyMixins(obj interface{}, schema nucleo.ServiceSchema) nucleo.ServiceSchema {
...
func copySettings(obj interface{}, schema nucleo.ServiceSchema) nucleo.ServiceSchema {
...
type aHandlerTemplate struct {
	...
	wrap  func(reflect.Value, interface{}) nucleo.ActionHandler
}

// handlerTemplate return an action hanler that is based on a template.
func handlerTemplate(m reflect.Value) nucleo.ActionHandler {
	obj := m.Interface()
...
func payloadToValue(t string, p nucleo.Payload) reflect.Value {
	if t == "Payload" {
...
func buildArgs(ptypes []string, p nucleo.Payload) []reflect.Value {
	args := []reflect.Value{}
	if p.IsArray() {
		list := p.Array()
...
func validateArgs(ptypes []string, p nucleo.Payload) error {
...
func valuesToPayload(vs []reflect.Value) nucleo.Payload {
...
func variableArgsHandler(m reflect.Value) nucleo.ActionHandler {
	ptypes := getParamTypes(m)
	return func(ctx nucleo.Context, p nucleo.Payload) interface{} {
...
func wrapAction(m reflect.Method, v reflect.Value) nucleo.Action {
	handler := handlerTemplate(v)
	if handler == nil {
		handler = variableArgsHandler(v)
	}
	return nucleo.Action{
...
func extractActions(obj interface{}) []nucleo.Action {
...
type HasCreated interface {
	Created(nucleo.ServiceSchema, *log.Entry)
}
...
func extractCreated(obj interface{}) nucleo.CreatedFunc {
	...
	if hasIt2 {
		return func(nucleo.ServiceSchema, *log.Entry) {
			creator2.Created()
		}
	}
	return nil
...
func extractStarted(obj interface{}) nucleo.LifecycleFunc {
	...
	if hasIt2 {
		return func(nucleo.BrokerContext, nucleo.ServiceSchema) {
			starter2.Started()
		}
	}
	return nil
...
func extractStopped(obj interface{}) nucleo.LifecycleFunc {
...
// checks if
func objToSchema(obj interface{}) (nucleo.ServiceSchema, error) {
	schema := nucleo.ServiceSchema{}
...
func mergeActions(actions ...[]nucleo.Action) []nucleo.Action {
	r := []nucleo.Action{}
...
func FromObject(obj interface{}, bkr *nucleo.BrokerDelegates) (*Service, error) {
...
func serviceLogger(bkr *nucleo.BrokerDelegates, schema nucleo.ServiceSchema) *log.Entry {
...
var actionHandlerTemplates = []aHandlerTemplate{
	//Complete action
	{
		match: func(obj interface{}) bool {
			_, valid := obj.(func(nucleo.Context, nucleo.Payload) interface{})
			return valid
		},
		wrap: func(m reflect.Value, obj interface{}) nucleo.ActionHandler {
			return obj.(func(nucleo.Context, nucleo.Payload) interface{})
		},
	},
	{
		match: func(obj interface{}) bool {
			_, valid := obj.(func(nucleo.Context, nucleo.Payload) nucleo.Payload)
			return valid
		},
		wrap: func(m reflect.Value, obj interface{}) nucleo.ActionHandler {
			ah := obj.(func(nucleo.Context, nucleo.Payload) nucleo.Payload)
			return func(ctx nucleo.Context, p nucleo.Payload) interface{} {
				return ah(ctx, p)
			}
		},
	...
	{
		match: func(obj interface{}) bool {
			_, valid := obj.(func(nucleo.Context, nucleo.Payload))
			return valid
		},
		wrap: func(m reflect.Value, obj interface{}) nucleo.ActionHandler {
			ah := obj.(func(nucleo.Context, nucleo.Payload))
			return func(ctx nucleo.Context, p nucleo.Payload) interface{} {
				ah(ctx, p)
				return nil
			}
	...
	{
		match: func(obj interface{}) bool {
			_, valid := obj.(func(nucleo.Context) interface{})
			return valid
		},
		wrap: func(m reflect.Value, obj interface{}) nucleo.ActionHandler {
			ah := obj.(func(nucleo.Context) interface{})
			return func(ctx nucleo.Context, p nucleo.Payload) interface{} {
				return ah(ctx)
			}
		},
	...
	{
		match: func(obj interface{}) bool {
			_, valid := obj.(func(nucleo.Context))
			return valid
		},
		wrap: func(m reflect.Value, obj interface{}) nucleo.ActionHandler {
			ah := obj.(func(nucleo.Context))
			return func(ctx nucleo.Context, p nucleo.Payload) interface{} {
				ah(ctx)
				return nil
			}
	...
	{
		match: func(obj interface{}) bool {
			_, valid := obj.(func(nucleo.Payload) interface{})
			return valid
		},
		wrap: func(m reflect.Value, obj interface{}) nucleo.ActionHandler {
			ah := obj.(func(nucleo.Payload) interface{})
			return func(ctx nucleo.Context, p nucleo.Payload) interface{} {
				return ah(p)
			}
		},
	...
	{
		match: func(obj interface{}) bool {
			_, valid := obj.(func(nucleo.Payload))
			return valid
		},
		wrap: func(m reflect.Value, obj interface{}) nucleo.ActionHandler {
			ah := obj.(func(nucleo.Payload))
			return func(ctx nucleo.Context, p nucleo.Payload) interface{} {
				ah(p)
				return nil
			}
